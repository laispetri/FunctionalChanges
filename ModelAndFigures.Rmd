...
parameters.wd <- file.path(workingdir, "modelparameters")
```
...
Predictions %>% 
  ...
  scale_y_continuous(limits = c(15, 39), breaks = seq(10, 37, by = 5)) +
  ...
  annotate("text", x = 14, y = 39, label = "(a)", hjust = 1.5, vjust = 1.5, size = 6, color = "black")
...
Predictions %>% 
  ...
  theme(text = element_text(size = 20),
        ...
        axis.title.x = element_blank(),
        legend.position = "none") +
  annotate("text", x = 14, y = 37, label = "(b)", hjust = 1.5, vjust = 1.5, size = 6, color = "black")
...
Predictions %>% 
  ...
  theme(text = element_text(size = 20),
        axis.text = element_text(size = 18),
        legend.position = "none")+
  annotate("text", x = 14, y = 0.6, label = "(c)", hjust = 1.5, vjust = 1.5, size = 6, color = "black")
...
parametersD %>%
  ...
  coord_cartesian(ylim = c(3.5,0.9), xlim = c(-10, 20),clip = "off")+
  theme_classic()+
  theme(text = element_text(size=20),
        axis.text = element_text(size=18),
        legend.position = "none")+
  guides(color=guide_legend(override.aes = list(linetype=0,size=5,shape=c(17,19))))+
  annotate("text", x = -7.5, y = 0.75, label = "(a)", hjust = 1.5, vjust = 1.5, size = 6, color = "black")
...
corValues %>%
  ...
  scale_y_continuous(name = "",breaks = c(1.15,2.15,3.15),trans="reverse",
                     labels = c("Leaf N and\nSLA","LDMC and\nSLA","Leaf N and\nLDMC"))+
  coord_cartesian(ylim = c(3.5,0.9), xlim = c(-0.3, 0.8),clip = "off")+
  theme_classic()+
  theme(text = element_text(size=20),
        axis.text = element_text(size=18),
        legend.text = element_text(size=14),
  ...
  guides(color=guide_legend(override.aes = list(linetype=0,size=5,shape=c(17,19))))+
  annotate("text", x = -0.2, y = 0.75, label = "(b)", hjust = 1.5, vjust = 1.5, size = 6, color = "black")
